...
function formValidation(e) {
    ...
    let valid = true;        
        ...
        function validateBirthday() {
            if (birthday.value === "") {
                formText.textContent ="Please enter your birthday.";
                birthday.focus();
                valid = false;
                return false;
            }
...
function teaFortuneGenerator() {
    let fortuneRandom = teaFortunes[Math.floor(Math.random() * teaFortunes.length)];
    return fortuneRandom
} 